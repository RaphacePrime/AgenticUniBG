...
const DIPARTIMENTI_CORSI = {
  ...
  "Dipartimento di Giurisprudenza": [
    ...
    { nome: "Giurisprudenza (riservato agli Allievi della Guardia di Finanza)", tipo: "Laurea Magistrale a ciclo unico (5 anni)" },
    { nome: "Diritto per l'impresa nazionale e internazionale", tipo: "Laurea" },
    { nome: "Diritti umani, migrazioni e cooperazione internazionale", tipo: "Laurea Magistrale" }
  ],
  "Dipartimento di Lettere, Filosofia, Comunicazione": [
    { nome: "Lettere", tipo: "Laurea" },
    { nome: "Filosofia", tipo: "Laurea" },
    { nome: "Filosofia, Scienze e Società", tipo: "Laurea Magistrale" },
    { nome: "Philosophical Knowledge: Foundations, Methods, Applications", tipo: "Laurea Magistrale" },
    { nome: "Culture umanistiche", tipo: "Laurea Magistrale" },
    { nome: "Comunicazione, Informazione, Editoria", tipo: "Laurea Magistrale" },
    { nome: "Scienze della comunicazione", tipo: "Laurea" },
    { nome: "Text Sciences and Culture Enhancement in the Digital Age", tipo: "Laurea Magistrale" },
    { nome: "Valorizzazione del patrimonio culturale materiale e immateriale", tipo: "Laurea Magistrale" }
  ],
  "Dipartimento di Lingue, Letterature e Culture Straniere": [
    { nome: "Lingue e letterature straniere moderne", tipo: "Laurea" },
    { nome: "Lingue moderne per la comunicazione e la cooperazione internazionale", tipo: "Laurea Magistrale" },
    { nome: "Intercultural Studies in Languages and Literatures", tipo: "Laurea Magistrale" }
  ],
  "Dipartimento di Scienze Aziendali": [
    { nome: "Economia aziendale", tipo: "Laurea" },
    { nome: "Economia aziendale, direzione amministrativa e professione", tipo: "Laurea Magistrale" },
    { nome: "International Management and Marketing", tipo: "Laurea Magistrale" },
    { nome: "Management, Innovazione e Finanza", tipo: "Laurea Magistrale" },
    { nome: "Accounting, Governance and Sustainability", tipo: "Laurea Magistrale" },
    { nome: "Welfare Management e Innovazione Sociale", tipo: "Laurea Magistrale" }
  ],
  "Dipartimento di Scienze Economiche": [
    ...
    { nome: "Geopolitica, Economia e Strategie Globali", tipo: "Laurea Magistrale" },
    { nome: "Planning and Management of Tourism Systems", tipo: "Laurea Magistrale" }
  ],
  "Dipartimento di Scienze Umane e Sociali": [
    { nome: "Scienze dell'educazione", tipo: "Laurea" },
    { nome: "Scienze pedagogiche", tipo: "Laurea Magistrale" },
    { nome: "Scienze della formazione primaria", tipo: "Laurea Magistrale a ciclo unico (5 anni)" },
    { nome: "Scienze psicologiche", tipo: "Laurea" },
    { nome: "Psicologia clinica", tipo: "Laurea Magistrale" },
    { nome: "Clinical Psychology for Individuals, Families and Organizations", tipo: "Laurea Magistrale" },
    { nome: "Scienze politiche e strategie globali", tipo: "Laurea" },
    { nome: "Scienze motorie e sportive", tipo: "Laurea" },
    { nome: "Scienze, metodi e didattiche delle attività sportive", tipo: "Laurea Magistrale" },
    { nome: "Progettazione di contesti di vita accessibili ed inclusivi", tipo: "Laurea Magistrale" }
  ],
  "Scuola di Ingegneria": [
    ...
    { nome: "Ingegneria delle tecnologie per l'elettronica e l'automazione", tipo: "Laurea" },
    { nome: "Ingegneria delle tecnologie per la salute", tipo: "Laurea" },
    { nome: "Medical Engineering", tipo: "Laurea Magistrale" },
    { nome: "Engineering and Management for Health", tipo: "Laurea Magistrale" },
    { nome: "Mechatronics and Smart Technology Engineering", tipo: "Laurea Magistrale" },
    { nome: "Ingegneria delle tecnologie per la sostenibilità energetica e ambientale", tipo: "Laurea" },
    { nome: "Geourbanistica. Analisi e pianificazione territoriale, urbana, ambientale e valorizzazione del paesaggio", tipo: "Laurea Magistrale" }
  ]
}
...
function LoginPage({ onLogin, onGuest }) {
  ...
  const availableCourses = useMemo(() => {
    ...
    return (DIPARTIMENTI_CORSI[registerData.department] || []).map(course => 
      ({ ...course, department: registerData.department })
    )
